...
//	var cameraObj camera.Cameras
//
//	if err := c.BodyParser(&cameraObj); err != nil {
//		return c.Status(400).JSON(fiber.Map{"message": "Failed to parse camera data"})
//	}
//
//	if !util.IsValidCamera(cameraObj.Type) {
//		return c.Status(400).JSON(fiber.Map{"message": "Invalid camera type"})
//	}
//
//	if err := database.DB.Create(&cameraObj).Error; err != nil {
//		return c.Status(500).JSON(fiber.Map{"message": "Internal server error"})
//	}
//
//	return c.Status(201).JSON(cameraObj)
//}
//
...
//	var cameraObj camera.Cameras
//
//	if err := database.DB.Where("id = ?", id).First(&cameraObj).Error; err != nil {
...
//		cameraObj.Type = updateCamera.Type
//	}
//	if updateCamera.Name != "" {
//		cameraObj.Name = updateCamera.Name
//	}
//
//	if err := database.DB.Save(&cameraObj).Error; err != nil {
//		return c.Status(500).JSON(fiber.Map{
//			"message": "Internal server error while updating camera",
//		})
//	}
//
//	return c.Status(200).JSON(cameraObj)
//}
//
...
//	}
//
//	if err := database.DB.Delete(&cameraObj).Error; err != nil {
//		return c.Status(500).JSON(fiber.Map{
...
//}
//
//// GetCamerasResponse represents paginated cameras response
...
//	Results    []camera.Cameras `json:"results"`
//}
//
...
//// @Success 200 {object} GetCamerasResponse
//// @Failure 500 {string} string "Internal server error"
