...
//	}
//	if updatedUser.ParkNumber != nil {
//		user.ParkNumber = updatedUser.ParkNumber
//	}
//
...
//	Results    []modelsuser.User `json:"results"`
//	Page       int               `json:"page"`
...
//}
//
//// GetOperators retrieves all users with the role "operator"
...
//// @Success 200 {object} GetOperatorsResponse "List of operators with pagination metadata"
