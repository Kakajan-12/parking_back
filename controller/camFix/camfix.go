...
//// @Param body UpdateCameraTypeRequest true "New camera type"
...
//	id := c.Params("id")
//	var dbObj camera.CamFix
//
//	if err := database.DB.Where("id = ?", id).First(&dbObj).Error; err != nil {
...
//// @Failure 500 {object} Response "Internal server error"
//// @Router /api/v1/delete-camera/{id} [delete]
...
//}
//
//type CameraFixType string
//
//const (
//	CameraFixInside  CameraFixType = "inside"
//	CameraFixOutside CameraFixType = "outside"
//)
//
...
//// @Router /api/v1/sync-cam-fix [get]
...
//				ChannelID:   channelId,
//				Type:        camera.CameraType(CameraFixOutside),
//			}
